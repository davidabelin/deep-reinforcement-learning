...
class PriorityReplay:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed, alpha=0.6):
        ...
        ======
            ...
            batch_size (int): size of each training batch
            seed (int): random seed
            alpha (float): parameter for prioritization, default value is 0.6
        """
        self.action_size = action_size
        self.batch_size = batch_size
    ...
    def add(self, experience): 
        """Add a new experience to memory with priority as the absolute difference between expected and sampled rewards.
           An experience is: state, action, reward, next_state, done, priority
        """
        self.memories.append(experience)
    
    def sample(self, beta=None):
        """Randomly sample a batch of experiences from memory with probabilities proportional to their priorities."""
