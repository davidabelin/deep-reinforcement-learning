...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed=SEED, 
                       fc1_units=64, fc2_units=64):   #, update_every=UPDATE_EVERY):
    ...
    def act(self, state, eps=0.5):
        ...
        ======
            ...
            eps (float): epsilon, for epsilon-greedy action selection
                         eps = 0: always chooses argmax(policy values)
                         eps = 1: always random
        """
        ...
        if random.random() > eps:
            ...
            with torch.no_grad():
                # Action values are raw outputs of network 
                # (ie. no activation function for last layer)
